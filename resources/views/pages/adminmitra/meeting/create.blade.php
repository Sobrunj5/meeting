        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent2">
                    <form action="{{ route('ruangmeeting.store') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        ...
                                        <input class="form-control {{$errors->has('nama_tempat')?'is-invalid':''}}"
                                               name="nama_tempat" type="text" value="{{old('nama_tempat')}}" />
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        ...
                                        <input class="form-control {{$errors->has('kapasitas')?'is-invalid':''}}"
                                               name="kapasitas" type="number" value="{{old('kapasitas')}}" />
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        ...
                                        <input class="form-control {{$errors->has('harga_sewa')?'is-invalid':''}}"
                                               name="harga_sewa" type="text" value="{{old('harga_sewa')}}" />
